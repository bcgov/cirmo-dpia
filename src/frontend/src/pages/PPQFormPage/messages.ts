export default {
  InitiativeFactorsHeading: {
    en: `1. Does the initiative involve any of the following? Check all that apply.`,
  },
  PiaTypeHeading: {
    en: `2. What kind of PIA are you submitting?`,
  },
  DelegatedTypeHeading: {
    en: `3. What kind of delegated review is it?`,
  },
  StartDateHeading: {
    en: `4. Is there a proposed start date for the initiative?`,
