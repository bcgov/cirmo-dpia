export default {
  ...
  PPQDescriptionTextInPIAIntake: {
    en: `For MPO and Privacy Office use only. Your answers will help the CPO determine the most efficient review pathway for your PIA.`,
  },
  PPQDescriptionText: {
  ...
  PPQDescriptionTextOne: {
    en: `The relative complexity of your PIA`,
  },
  PPQDescriptionTextTwo: {
    en: `Which PIA template you should fill out`,
  },
  PPQDescriptionTextThree: {
    en: `Where to go for help with your PIA`,
  },
};
