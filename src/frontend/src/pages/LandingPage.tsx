...
import fillForm from '../assets/undraw_fill_form.svg'
    ...
    return (
        <div>
            <section className='hero-section'>
                <div className="hero-content">
                    ...
                    <div className="ctas">
                        ...
                        <a href="/" className="btn-secondary">Contact <FontAwesomeIcon className='icon' icon={faEnvelope} /></a>
                    </div>
                </div>
            ...
            <section className="what-is-a-pia">
                ...
                <a href='/'>Learn about the current PIA process</a>
            </section>
            <section className="info-section">
                <div className="problem-subsec">
                    ...
                    <div className='info-subsec-text'>
                        <h2>Problem</h2>
                        <p>The Privacy, Compliance and Training (PCT) is government’s corporate privacy office and has the mandate to review all PIAs for BC government ministries. PCT has seen a 686% increase in PIAs submitted for review in within a 10 year period. While the increase in volume is exponential, the statistics do not reflect the pressures that result from increased complexity of PIA submissions. </p>
                    </div>
                </div>
                <div className="hypothesis-subsec">
                    ...
                    <div className='info-subsec-text'>
                        <h2>Hypothesis</h2>
                        <p>The DPIA will alleviate unsustainable workload pressures, connect siloed information, support innovation, reduce repetition in the PIA process and enable compliance with legislated PIA requirements.</p>
                    </div>
                </div>
                <div className="vision-subsec">
                    ...
                    <div className='info-subsec-text'>
                        <h2>Vision</h2>
                        <p>The DPIA will be an integrated, guided, online tool for the for anyone working in a BC ministry that needs to complete a PIA. Digitizing the PIA will create a streamlined experience that enables a culture of privacy and innovation. </p>
                    </div>
                </div>
            </section>
        </div>
